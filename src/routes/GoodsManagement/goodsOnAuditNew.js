...
import {ChangeGoodsOnAuditModalNew,CheckGoodsOnAuditModalNew} from './goodsOnAuditModalNew';
// import CheckGoodsOnAuditModal from './changeGoodsOnAuditModal';
import styles from './goodsOnAuditNew.less';
...
export default class goodsOnAudit extends Component {
  ...
  init(){
    this.props.dispatch({
      type: 'goodsManagementNew/getGoodsOnAuditList',
      payload: {
        userId:userId,
      },
    });
  ...
  handleCheck=(e, record, index)=>{
    this.props.dispatch({
      type:'goodsManagementNew/getGoodsDetailsAndOther',
      payload:{
        userId:userId,
        logId:record.id
      }
  ...
  render() {
    const { goodsManagementNew:{goodsOnAudit:{tableData}} } = this.props;
    ...
    return (
      <div>
        ...
        <ChangeGoodsOnAuditModalNew
        />
        <CheckGoodsOnAuditModalNew
        />
      </div>
    );
  }
