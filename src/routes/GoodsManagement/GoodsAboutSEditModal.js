...
@connect(({ goodsManagement, loading }) => ({
  goodsManagement,
  loading: loading.effects['goodsManagement/getGoodsDetailsS'],
}))
@Form.create()
export default class GoodsAboutSEditModal extends React.PureComponent {
  ...
  render() {
    ...
    const {goodsManagement:{goodsAboutData:{childCheckS}}} = this.props;
                ...
                <Col span={11} offset={1}>
                  <div>
                    <div style={divRowName}>
                      ...
                      <span>{childCheckS.goodsName}</span>
                    </div>
                    <div style={divRow}>
                      <label htmlFor="" style={labelWidth}>品牌名称 </label>
                      <span >{childCheckS.brand}</span>
                    </div>
                    {/*<div style={divRow}>*/}
