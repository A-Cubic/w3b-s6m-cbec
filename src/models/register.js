import { realRegisterCode, realRegisterSubmit,realChangenameSubmit,realRenameCode,realRenameSubmit } from '../services/api';
...
export default {
  ...
  effects: {
    ...
    *changename({payload, callback}, { call, put }) {
      const response = yield call(realChangenameSubmit,payload);
      if (response === undefined) {
