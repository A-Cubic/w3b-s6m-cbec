      ...
      <Form onSubmit={this.onSearch} layout="inline">
        ...
        <div style={{ overflow: 'hidden',marginBottom:10,fontSize:16 }}>
          <div style={{ float: 'right' }}>
            ...
            <span>订单总销售额：{tableData?tableData.item.salesNumTotal:0}， </span>
            <span>供货总结算额：¥{tableData?tableData.item.salesPriceTotal:0}， </span>
            <span>佣金总结算额：¥{tableData?tableData.item.costTotal:0}， </span>
            <span>平台总提点额：¥{tableData?tableData.item.grossProfitTotal:0}</span>
